...
import { ArrowLeft, FileText, Paperclip, X, Save, Loader as Loader2, StickyNote, Mic, Square, Play, Pause, RotateCcw, CircleAlert as AlertCircle } from 'lucide-react';
...
export function ClientNoteFormPage() {
      ...
      >
        <div className="flex items-center gap-3">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => navigate(`/clients/${state.clientId}`, { state: { activeTab: 'sessions-notes' } })}
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-muted-foreground">Modello (opzionale)</label>
          <Select value={selectedTemplate} onValueChange={setSelectedTemplate}>
            <SelectTrigger className="w-full h-11 rounded-xl">
              <SelectValue placeholder="Nessun modello selezionato" />
            </SelectTrigger>
        ...
        <div className="space-y-3">
          ...
          <Textarea
            ...
            placeholder="Scrivi qui le note per questo paziente…"
        ...
        <div className="space-y-3">
          ...
          >
            ...
            {files.length > 0 ? 'Aggiungi un altro file' : 'Allega file o documento'}
          </Button>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold">Memo vocale</span>
            <span className="text-xs text-muted-foreground ml-auto">opzionale</span>
          </div>
          ...
          <Card className="rounded-2xl border overflow-hidden">
            {recorder.recordingState === 'idle' && (
              <div className="flex flex-col items-center justify-center gap-4 p-8">
                ...
                <p className="text-sm text-muted-foreground">Tocca per iniziare la registrazione</p>
                {recorder.error && (
            ...
            {recorder.recordingState === 'recording' && (
              <div className="flex flex-col items-center justify-center gap-4 p-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-muted-foreground">registrazione — tocca per fermare</span>
                </div>
              </div>
            )}
            ...
            {recorder.recordingState === 'stopped' && (
              <div className="flex items-center gap-3 p-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium">Memo vocale</p>
                  <p className="text-xs text-muted-foreground">
                    {formatDuration(recorder.duration)} · salvato al momento del submit
                  </p>
                </div>
                <Button
                  variant="ghost"
          ...
          >
            {isSaving ? (
              ...
              <>
                ...
                {hasContent ? 'Salva nota' : 'Crea nota vuota'}
              </>
            )}
          </Button>
        </div>
